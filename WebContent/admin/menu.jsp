	  ...
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      ...
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	              <li><a href='<%=path %>/admin/stu/stuMana.jsp' target='main'>客户管理</a> </li>
	              <li><a href='<%=path %>/admin/stu/stuAdd.jsp' target='main'>客户录入</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
	      ...
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/admin/goods/goodsMana.jsp' target='main'>商品管理</a> </li>
	              <li><a href='<%=path %>/admin/goods/goodsAdd.jsp' target='main'>商品录入</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
	      ...
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	              <li><a href='<%=path %>/admin/order/orderMana.jsp' target='main'>订单管理</a> </li>
	          </ul>
	        </dd>
	      </dl>
		  </td>
